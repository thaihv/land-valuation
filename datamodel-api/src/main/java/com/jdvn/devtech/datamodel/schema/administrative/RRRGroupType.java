...
public class RRRGroupType {
	...
	@Comment("Displayed value of the RRR group type.")
	private String display_value;

	@Column(length = 1000)
	@Comment("Description of the RRR group type.")
	private String description;

	@Column(columnDefinition = "character(1) default 'a'")
	@Comment("Status in active of the RRR group type as active (a) or inactive (i).")
	private char status;

	@OneToOne(mappedBy = "rrr_group_type")
