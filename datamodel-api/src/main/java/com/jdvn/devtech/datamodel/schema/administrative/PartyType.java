...
public class PartyType {
	...
	@Comment("Displayed value of the party type.")
	private String display_value;

	@Column(length = 1000)
	@Comment("Description of the party type.")
	private String description;

	@Column(columnDefinition = "character(1) default 'a'")
	@Comment("Status in active of the party type as active (a) or inactive (i).")
	private char status;

	@OneToOne(mappedBy = "party_type")
	private Party party;
}