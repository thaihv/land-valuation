...
public class ModelHasBaseValue {  
	...
	@Comment("The id of the model associated. If the constant is not generated by a model of mass appraisal procedures it can be NULL as this constant is almost predefined for a parameter in a formula.")
