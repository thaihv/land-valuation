...
public class RRRStatusType {
	...
	@Comment("Code of the rrr status type.")
	private String code;

	@Column(length = 500, nullable = false)
	@Comment("Displayed value of the rrr status type.")
	private String display_value;

	@Column(length = 1000)
	@Comment("Description of the rrr status type.")
	private String description;

	@Column(columnDefinition = "character(1) default 'a'")
	@Comment("Status in active of the rrr status type as active (a) or inactive (i).")
	private char status;

	@OneToOne(mappedBy = "rrr_status_type")
	private RRR rrr;
}