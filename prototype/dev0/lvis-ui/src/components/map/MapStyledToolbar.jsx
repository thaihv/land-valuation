...
const WatermarkControl = ({ imgUrl, text }) => {
  const map = useMap();
  useEffect(() => {
    const Watermark = L.Control.extend({
      onAdd: () => {
        ...
        if (text) {
          ...
          watermarkText.style.backgroundColor = 'rgba(0, 0, 0, 0.5)';
          watermarkText.style.padding = '2px 5px';
  ...
  return (
    <div style={{ position: 'relative', height: '100vh' }}>
      ...
      >
        ...
        />
        <WatermarkControl
          imgUrl="./monre.svg" // Replace with your image URL
          text="LVIS"
        />
