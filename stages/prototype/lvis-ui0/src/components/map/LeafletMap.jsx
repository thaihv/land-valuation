...
export default function LeafletMap() {
  ...
  useEffect(() => {
    ...
    const parcel_tech = L.tileLayer.wms(
      `${import.meta.env.VITE_GEOMAP_GWC_URL_BK}`,
      {
        maxZoom: 20,
    ...
    const parcel_re = L.tileLayer.wms(
      `${import.meta.env.VITE_GEOMAP_WMS_URL_BK}`,
      {
        maxZoom: 20,
